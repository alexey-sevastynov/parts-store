...
export default function CategoryForm() {
  ...
  return (
    <form className={Styles.categoryForm} onSubmit={handleSubmit}>
      <span className={Styles.categoryForm__line} />
      <div className={Styles.categoryForm__inputs}>
      ...
      {/* {notification && (
        <div className={Styles.categoryForm__notification}>
      ...
      {/* <div className={Styles.categoryForm__submit}>
        <Button
          type='submit'
          disabled={
            !state.nameUa ||
